...
echo
echo "이제 claude 를 실행하면 enabledPlugins/extraKnownMarketplaces 기준으로 플러그인 8개가 자동 설치됩니다."
echo "각 스킬 설명은 SKILLS.md 참고. 자동 설치가 안 되면 claude 안에서 수동 실행:"
...
echo "  /plugin install understand-anything@understand-anything"
